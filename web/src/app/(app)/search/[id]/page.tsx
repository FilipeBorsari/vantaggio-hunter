...
function SkeletonRow() {
  return (
    <div className="grid grid-cols-[200px_1fr_160px_120px_80px] gap-2 items-center px-4 h-12 border-b border-gray-50 animate-pulse">
      {[200, 300, 120, 80, 60].map((w, i) => (
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="flex-1 bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col min-h-0">
        {/* Header */}
        <div className="grid grid-cols-[200px_1fr_160px_120px_80px] gap-2 px-4 py-3 bg-gray-50 border-b border-gray-100 text-xs font-medium text-gray-600 shrink-0">
          <span>CNPJ</span>
              ...
              {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[200px_1fr_160px_120px_80px] gap-2 items-center px-4 border-b border-gray-50 hover:bg-gray-50 text-sm"
                  >
